...
ttps://ai.hackclub.com/proxy/v1/chat/completions) for the AI testing however the user can provide any URL. The LLM model can also be configured in the [configuration file](https://github.com/bowlofneighs/subrub/Documentation.md#Configuration). Subrub uses LibCurl for
